...
const consumerBuilder = new WorkloadBuilder(app, 'consumer-builder', '5herlocked', 'main', 'video-consumer-knative-microservice', { env });
const ingesterBuilder = new WorkloadBuilder(app, 'ingest-builder', '5herlocked', 'main', 'kinesis-knative-ingest', { env });
